...
#define GPIO_7_A2 218  //out_1
#define GPIO_1_D3 51   //out_2
#define GPIO_3_C1 105  //out_3
#define GPIO_1_D0 48   //out_4
#define GPIO_2_A7 63   //out_5
#define GPIO_1_D1 49   //in_1
#define GPIO_2_B0 64   //in_2
#define GPIO_1_D2 50   //in_3
#define GPIO_2_B1 65   //in_4
#define GPIO_2_B2 66   //in_5
...
//	struct device_node *gz_gpio_node = pdev->dev.of_node;
	...
	if (gpio_request(GPIO_1_D3, "out_2")) {
			printk("gpio %d request failed!\n",GPIO_1_D3);
			return ret;
	}
	printk("gpio %d request success!\n",GPIO_1_D3);
	...
	if (gpio_request(GPIO_3_C1, "out_3")) {
			printk("gpio %d request failed!\n",GPIO_3_C1);
			return ret;
	}
	printk("gpio %d request success!\n",GPIO_3_C1);
	...
	if (gpio_request(GPIO_1_D0, "out_4")) {
			printk("gpio %d request failed!\n",GPIO_1_D0);
			return ret;
	}
	printk("gpio %d request success!\n",GPIO_1_D0);
	...
	if (gpio_request(GPIO_2_A7, "out_5")) {
			printk("gpio %d request failed!\n",GPIO_2_A7);
			return ret;
	}
	printk("gpio %d request success!\n",GPIO_2_A7);
